...
def load_latlong():
    """
    Load load_test_latlong.json
    """
    latlong = {}
    with open("./load_test_env_conf/load_test_latlong.json", mode="rt", encoding="utf-8") as f:
...
def load_link():
    """
    Load load_test_link.json
    """
    link_json = {}
    with open("./load_test_env_conf/load_test_link.json", mode="rt", encoding="utf-8") as f:
...
if enable_auto:
    ...
    cli.timestamp_load_test(net, "-c 32")
'''
...
output_file_name = 'p4mininet/' + name + '_network.py'
